        ...
        <div ref={containerRef}>
            ...
            <main>
                ...
                <footer className="footer-immersive">
                    ...
                    <div className="footer-map" style={{ marginTop: '3rem', width: '100%', maxWidth: '800px', height: '250px', borderRadius: 'var(--radius-card)', overflow: 'hidden', backgroundColor: 'var(--c-bg-deep)' }}>
                        <iframe 
                            ...
                            width="100%" 
                            height="100%" 
                            style={{ border: 0, filter: 'grayscale(100%) opacity(0.8)', mixBlendMode: 'multiply' }} 
                            allowFullScreen="" 
                            loading="lazy" 
